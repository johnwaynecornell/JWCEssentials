...
public class GenericAggregateTests
{
    ...
    {
        [Metric]
        [MetricHelp("Item name")]
        public string Name { get; init; } = "";

        [Metric]
        [MetricHelp("Item score")]
        public int Score { get; init; }

        [Metric]
        [MetricHelp("Item factor")]
        public double Factor { get; init; }

        [Metric]
        [MetricHelp("Dynamic object value")]
        public object? DynamicVal { get; init; }

        [Metric]
        [MetricHelp("Self item")]
    ...
    {
        [Metric]
        [MetricHelp("Sum of integer list")]
        ...
        [Metric]
        [MetricHelp("Mixed scalar and aggregate")]
        ...
        [Metric]
        [MetricHelp("Dual aggregates with different types")]
