...
public class TypedLiteralBindingTests
{
    ...
    private static MetricCatalogs CreateReflectedCatalogs()
    {
        ...
        catalogs.Reflect = MetricCatalogs.DefaultReflect;
        return catalogs;
    }
    ...
    {
        var catalog = MetricCatalogs.DefaultReflect(typeof(TestRecord));
